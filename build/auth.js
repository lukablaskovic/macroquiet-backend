...
createIndexOnLoad();
var _default = {
  setToken: function setToken(username, email) {
    var user = {
      username: username,
      email: email
    };
    var tokenDuration = "7d";

    var token = _jsonwebtoken["default"].sign(user, process.env.JWT_SECRET || "much_secret", {
      algorithm: "HS512",
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 11:
              ...
              token = _jsonwebtoken["default"].sign(user, process.env.JWT_SECRET || "much_secret", {
                algorithm: "HS512",
                expiresIn: tokenDuration
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              _context3.next = 10;
              return checkUser(old_password, user.password);
            ...
            case 14:
              new_password_hashed = _context3.sent;
              _context3.next = 17;
            ...
            case 17:
              ...
              return _context3.abrupt("return", result.modifiedCount == 1);
  ...
  changeUserUsername: function changeUserUsername(old_username, new_username) {
  ...
  changeUserEmail: function changeUserEmail(username, new_email) {
  ...
  verify: function verify(req, res, next) {
    try {
      ...
      if (type !== "Bearer") {
        ...
        req.jwt = _jsonwebtoken["default"].verify(token, process.env.JWT_SECRET || "much_secret"); //Ako je sve OK, ako verify prode, exctractaj podatke u req.jwt i idi next()
...
function _createIndexOnLoad() {
  _createIndexOnLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var db;
...
function _encrypt() {
  _encrypt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(plainTextPassword) {
    var hashedPassword;
...
function _checkUser() {
  _checkUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(password, passwordHash) {
    var match;
