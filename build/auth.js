...
function _createIndexOnLoad() {
  _createIndexOnLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var db;
...
function _encrypt() {
  _encrypt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(plainTextPassword) {
    var hashedPassword;
...
function _checkUser() {
  _checkUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(password, passwordHash) {
    var match;
